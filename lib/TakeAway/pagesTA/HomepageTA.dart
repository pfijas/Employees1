...
class _HomepageState extends State<HomeScreenTA>
  ...
  Widget buildLandscapeLayout() {
    return Row(
      children: [
        Expanded(child: buildBottomNavigationBarLanscape()),
        Container(
          height: double.infinity,
          width: 900,
          child: Scaffold(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          "",
                          // Display the selected table name here
                          style: TextStyle(
                              fontSize: 20, fontWeight: FontWeight.bold),
                        )
                      ],
  ...
  Widget buildBottomNavigationBarLanscape() {
    return Container(
      child: Card(
        color: Colors.white70,
        child: Padding(
                                    ...
                                    InkWell(
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          Card(
                                              shape: RoundedRectangleBorder(
                                                borderRadius: BorderRadius.circular(6.0), // Set the radius to 0 for square edges
                                              ),
                                              child: Padding(
